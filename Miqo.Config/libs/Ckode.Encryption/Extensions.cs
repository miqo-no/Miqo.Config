...
namespace Ckode.Encryption
{
    ...
    {
        internal static T[] GetSubArray<T>(this T[] array, int startIndex)
        {
            var length = array.Length - startIndex;
            return array.GetSubArray(startIndex, length);
        }

        internal static T[] GetSubArray<T>(this T[] array, int startIndex, int length)
        {
        ...
        internal static void Insert<T>(this T[] destinationArray, int startIndex, T[] subArray)
        {

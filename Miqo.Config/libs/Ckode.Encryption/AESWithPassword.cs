...
namespace Ckode.Encryption
{
	...
	/// </summary>
	internal class AESWithPassword
	{
		...
		internal AESWithPassword(int iterations = 1 << 15)
		{
		...
		internal byte[] Encrypt(string text, Encoding encoding, string password)
		{
		...
		/// <param name="password">Password to use as encryption key.</param>
		internal byte[] Encrypt(byte[] bytes, string password)
		{
		...
		internal byte[] Decrypt(byte[] bytes, string password)
		{
		...
		/// <param name="encoding">Encoding of the string.</param>
		/// <param name="password">Password the cipher was encrypted with.</param>
		internal string Decrypt(byte[] bytes, Encoding encoding, string password)
		{
